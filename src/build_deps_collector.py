...
def main(root_target, prefix_path, bazel_config, output_path, build_file_name):
  ...
  bazel_runner = runner.BazelRunner()
  bazel_query_parser = parser.BazelBuildTargetsParser(prefix_path)
  targets_collector = runner.TargetsCollector(bazel_runner, bazel_query_parser)
  ...
  node_kind_printer = printer.BasicPrinter()
