...
class TfRules:
  _RULES: Dict[str, Rule] = {
      ...
      "generate_op_reg_offsets": Rule(kind="generate_op_reg_offsets",
                                      ...
                                      bool_args=["testonly"],
                                      out_label_args=["out"],
                                      import_statement='load("//tensorflow:tensorflow.bzl", "generate_op_reg_offsets")'),
      ...
      "check_deps": Rule(kind="check_deps",
                         label_list_args=["deps", "disallowed_deps",
                                          "required_deps"],
                         import_statement='load("//tensorflow:tensorflow.bzl", "check_deps")'),
      "gentbl_test": Rule(kind="gentbl_test",
                          label_list_args=["deps", "td_srcs"],
                          label_args=["tblgen", "td_file"],
                          string_list_args=["opts", "includes"],
                          import_statement='load("@llvm-project//mlir:tblgen.bzl", "gentbl_test")'),
      ...
      "api_gen_rule": Rule(kind="api_gen_rule", label_list_args=["srcs"],
                           ...
                           out_label_list_args=["outs"],
                           import_statement='load("//tensorflow/python/tools/api/generator:api_gen.bzl", "api_gen_rule")'),
      ...
      "generate_cc": Rule(kind="generate_cc",
                          ...
                          macro=True),
      "filegroup_as_file": Rule(kind="filegroup_as_file", label_args=["dep"],
                                macro=True,
                                import_statement='load("//tensorflow:tensorflow.bzl", "filegroup_as_file")'),
      "flatbuffer_py_library": Rule(kind="flatbuffer_py_library",
                                    label_list_args=["srcs", "deps"],
                                    string_list_args=["include_paths"],
                                    macro=True,
                                    import_statement='load("@flatbuffers//:build_defs.bzl", "flatbuffer_py_library")'),
      "transitive_hdrs": Rule(kind="transitive_hdrs",
                              label_list_args=["deps"],
                              macro=True,
                              import_statement='load("//tensorflow:tensorflow.bzl", "transitive_hdrs")'),
      ...
      "tf_version_info_genrule": Rule(kind="tf_version_info_genrule",
                                      ...
                                      macro=True,
                                      visibility=False,
                                      import_statement='load("//tensorflow:tensorflow.default.bzl", "tf_version_info_genrule")'),

      # public copy of _tfcompile_model_library
      "tfcompile_model_library": Rule(kind="tfcompile_model_library",
                                      label_list_args=["srcs",
                                                       "dfsan_abilists"],
                                      label_args=["tfcompile_tool",
                                                  "tfcompile_graph",
